...
const TOURNAMENTS = [
  ...
  { id:'theopen',  name:'The Open',          short:'The Open',  course:'Royal Birkdale',       location:'Southport, England', dates:'Jul 16–19, 2026', start:'2026-07-16', end:'2026-07-19', feed:null, type:'hardcoded', cutPos:70, cutRound:2 },
...
// ─── THE OPEN 2026 FINAL (locked snapshot · ESPN leaderboard event 401811957) ──
const THEOPEN_2026_FINAL = [
  { name:"Ryan Fox",                score:-10, thru:"F",  pos:"1",    status:"active" },
  { name:"Cameron Young",           score: -9, thru:"F",  pos:"2",    status:"active" },
  { name:"Sam Burns",               score: -8, thru:"F",  pos:"3",    status:"active" },
  { name:"Tommy Fleetwood",         score: -7, thru:"F",  pos:"T4",   status:"active" },
  { name:"Scottie Scheffler",       score: -7, thru:"F",  pos:"T4",   status:"active" },
  { name:"Lucas Herbert",           score: -6, thru:"F",  pos:"T6",   status:"active" },
  { name:"Casey Jarvis",            score: -6, thru:"F",  pos:"T6",   status:"active" },
  { name:"Si Woo Kim",              score: -6, thru:"F",  pos:"T6",   status:"active" },
  { name:"Adam Scott",              score: -5, thru:"F",  pos:"T9",   status:"active" },
  { name:"Ludvig Åberg",            score: -5, thru:"F",  pos:"T9",   status:"active" },
  { name:"Rasmus Neergaard-Petersen", score: -5, thru:"F",  pos:"T9",   status:"active" },
  { name:"Ryan Gerard",             score: -5, thru:"F",  pos:"T9",   status:"active" },
  { name:"Russell Henley",          score: -5, thru:"F",  pos:"T9",   status:"active" },
  { name:"Bryson DeChambeau",       score: -4, thru:"F",  pos:"T14",  status:"active" },
  { name:"Sungjae Im",              score: -4, thru:"F",  pos:"T14",  status:"active" },
  { name:"Hideki Matsuyama",        score: -4, thru:"F",  pos:"T14",  status:"active" },
  { name:"Corey Conners",           score: -4, thru:"F",  pos:"T14",  status:"active" },
  { name:"Xander Schauffele",       score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Collin Morikawa",         score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Daniel Brown",            score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Rickie Fowler",           score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Alex Noren",              score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Kristoffer Reitan",       score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Marco Penge",             score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Chris Gotterup",          score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Bud Cauley",              score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Jordan Smith",            score: -3, thru:"F",  pos:"T18",  status:"active" },
  { name:"Victor Perez",            score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Robert MacIntyre",        score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Cameron John",            score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Shane Lowry",             score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"John Parry",              score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Pierceson Coody",         score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Jackson Suber",           score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Jacob Bridgeman",         score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Kazuma Kobori",           score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Patrick Cantlay",         score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Brooks Koepka",           score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"Max Homa",                score: -2, thru:"F",  pos:"T28",  status:"active" },
  { name:"J.J. Spaun",              score: -1, thru:"F",  pos:"T40",  status:"active" },
  { name:"Kurt Kitayama",           score: -1, thru:"F",  pos:"T40",  status:"active" },
  { name:"Matt Wallace",            score: -1, thru:"F",  pos:"T40",  status:"active" },
  { name:"Rory McIlroy",            score: -1, thru:"F",  pos:"T40",  status:"active" },
  { name:"Michael Thorbjornsen",    score: -1, thru:"F",  pos:"T40",  status:"active" },
  { name:"Thomas Detry",            score: -1, thru:"F",  pos:"T40",  status:"active" },
  { name:"Francesco Molinari",      score:  0, thru:"F",  pos:"T46",  status:"active" },
  { name:"Eugenio Chacarra",        score:  0, thru:"F",  pos:"T46",  status:"active" },
  { name:"Josele Ballester",        score:  0, thru:"F",  pos:"T46",  status:"active" },
  { name:"Patrick Reed",            score:  0, thru:"F",  pos:"T46",  status:"active" },
  { name:"Matthew Southgate",       score:  0, thru:"F",  pos:"T46",  status:"active" },
  { name:"Jon Rahm",                score:  0, thru:"F",  pos:"T46",  status:"active" },
  { name:"Hennie Du Plessis",       score:  0, thru:"F",  pos:"T46",  status:"active" },
  { name:"Eric Cole",               score:  1, thru:"F",  pos:"T53",  status:"active" },
  { name:"Sahith Theegala",         score:  1, thru:"F",  pos:"T53",  status:"active" },
  { name:"Ryo Hisatsune",           score:  1, thru:"F",  pos:"T53",  status:"active" },
  { name:"Michael Brennan",         score:  1, thru:"F",  pos:"T53",  status:"active" },
  { name:"Shaun Norris",            score:  1, thru:"F",  pos:"T53",  status:"active" },
  { name:"Alex Smalley",            score:  1, thru:"F",  pos:"T53",  status:"active" },
  { name:"Nick Taylor",             score:  2, thru:"F",  pos:"T59",  status:"active" },
  { name:"Ben Griffin",             score:  2, thru:"F",  pos:"T59",  status:"active" },
  { name:"Min Woo Lee",             score:  2, thru:"F",  pos:"T59",  status:"active" },
  { name:"Naoyuki Kataoka",         score:  2, thru:"F",  pos:"T59",  status:"active" },
  { name:"Aldrich Potgieter",       score:  2, thru:"F",  pos:"T59",  status:"active" },
  { name:"Johnny Keefer",           score:  2, thru:"F",  pos:"T59",  status:"active" },
  { name:"Peter Uihlein",           score:  3, thru:"F",  pos:"T65",  status:"active" },
  { name:"Justin Thomas",           score:  3, thru:"F",  pos:"T65",  status:"active" },
  { name:"Nico Echavarria",         score:  4, thru:"F",  pos:"T67",  status:"active" },
  { name:"Sepp Straka",             score:  4, thru:"F",  pos:"T67",  status:"active" },
  { name:"Tyrrell Hatton",          score:  5, thru:"F",  pos:"T69",  status:"active" },
  { name:"Andy Sullivan",           score:  5, thru:"F",  pos:"T69",  status:"active" },
  { name:"Alex Fitzpatrick",        score:  6, thru:"F",  pos:"T71",  status:"active" },
  { name:"Laurie Canter",           score:  6, thru:"F",  pos:"T71",  status:"active" },
  { name:"MJ Daffue",               score:  6, thru:"F",  pos:"T71",  status:"active" },
  { name:"Keegan Bradley",          score:  7, thru:"F",  pos:"T74",  status:"active" },
  { name:"Kazuki Higa",             score:  7, thru:"F",  pos:"T74",  status:"active" },
  { name:"Marcus Plunkett",         score:  7, thru:"F",  pos:"T74",  status:"active" },
  { name:"Jack McDonald",           score:  8, thru:"F",  pos:"77",   status:"active" },
  { name:"Jesper Svensson",         score:  9, thru:"F",  pos:"78",   status:"active" },
  { name:"J.T. Poston",             score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Aaron Rai",               score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Nicolai Højgaard",        score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Andrew Novak",            score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Billy Horschel",          score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Bernd Wiesberger",        score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Tom McKibbin",            score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Antoine Rozner",          score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Daniel Hillier",          score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Sam Stevens",             score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Sami Välimäki",           score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Jayden Schaper",          score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Matt McCarty",            score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Mason Howell",            score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Harris English",          score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Joakim Lagergren",        score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Henrik Stenson",          score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Cameron Smith",           score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Jake Knapp",              score:  2, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Wyndham Clark",           score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Travis Smyth",            score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Tom Kim",                 score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Ryutaro Nagano",          score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Keita Nakajima",          score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Angel Ayora",             score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"David Howard",            score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Justin Rose",             score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Keith Mitchell",          score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Maverick McNealy",        score:  3, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Joaquín Niemann",         score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Thomas Sloman",           score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Jason Day",               score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Viktor Hovland",          score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Akshay Bhatia",           score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Harry Hall",              score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Frederic LaCroix",        score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Bard Bjornevik Skogen",   score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Nevill Ruiter",           score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Mateo Pulcini",           score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Joe Dean",                score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Michael Hollick",         score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Matt Fitzpatrick",        score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Haotong Li",              score:  4, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Max Greyserman",          score:  5, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Alistair Docherty",       score:  5, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"James Nicholas",          score:  5, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Jack Buchanan",           score:  5, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Michael Kim",             score:  5, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Rasmus Højgaard",         score:  6, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Tim Wiedemeyer",          score:  6, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Stuart Grehan",           score:  6, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Alejandro de Castro Piera", score:  6, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Adrien Saddier",          score:  6, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Daniel Berger",           score:  6, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Sam Bairstow",            score:  7, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Lev Grinberg",            score:  7, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Martin Couvra",           score:  7, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Caleb Surratt",           score:  7, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Jiho Yang",               score:  7, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Matthew Baldwin",         score:  7, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Darren Clarke",           score:  7, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Stewart Cink",            score:  8, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Scott Vincent",           score:  8, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Brian Harman",            score:  9, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Padraig Harrington",      score:  9, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Gary Woodland",           score:  9, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Matthew Jordan",          score:  9, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Jeong-Woo Ham",           score:  9, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Dan Bradbury",            score:  9, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Kota Kaneko",             score:  9, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Francesco Laporta",       score:  9, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"David Duval",             score: 10, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Tiger Christensen",       score: 10, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Jordan Spieth",           score: 10, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"David Puig",              score: 11, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Austen Truslow",          score: 13, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Ren Yonezawa",            score: 15, thru:"",   pos:"CUT",  status:"CUT" },
  { name:"Fifa Laopakdee",          score: 15, thru:"",   pos:"CUT",  status:"CUT" },
];

const HARDCODED_FINALS = { masters: MASTERS_2026_FINAL, pga: PGA_2026_FINAL, usopen: USOPEN_2026_FINAL, theopen: THEOPEN_2026_FINAL, tourchamp: TOURCHAMP_2026_FINAL };
...
const FINALS_DATA_VERSION = '2026-v10';
(function seedFinals(){
  if(retrieve('finals_data_version') !== FINALS_DATA_VERSION) {
    ...
    saveFinal('theopen',   calcPool(THEOPEN_PICKS,   THEOPEN_2026_FINAL));
